...
public class Plane_Dynamic {
    int cheapestPrice, numOfPaths;
    private Node[][] mat;

    public Plane_Dynamic(Node[][] mat) {
        this.mat = mat;
        cheapestPrice = 0;
        numOfPaths = 0;
        buildMatrix();
    ...
    public static void main(String[] args) {
        ...
        Plane_Dynamic bp = new Plane_Dynamic(mat);
        ...
        Plane_Dynamic b = new Plane_Dynamic(mat2);
